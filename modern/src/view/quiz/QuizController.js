Ext.define('Admin.view.quiz.QuizController', {
    ...
    onLoadQuizSoal: function (panel, container, index, eOpts ) {
        var me                = this;
        var lembarjawab       = me.getView().down('#lembarquizjawab');
        ...
        Ext.Ajax.request({
            ...
            params: {
                id_quiz: panel.datarecord.data['id'],
            ...
            success: function(response) {
                var json = Ext.JSON.decode(response.responseText);
                    if(json['success']) {
                        ...
                        //console.log(hr+':'+min);
                        me.onQuizShow(panel.datarecord.data['waktu'], panel.pembahasan);
    ...
    onPilihSoal: function (dataview, record ) {
        var lembarsoal        = this.getView().down('#lembarquizsoal');
    ...
    onPilihJawaban: function ( dataview, location, eOpts ) {
        var pembahasan = dataview.up('quiz-view').pembahasan;
    ...
    onQuizShow: function(duration, pembahasan) {
        var me = this;
    ...
    onFinish: function(btn) {
        var me         = this;
        var view       = me.getView();
        var pembahasan = btn.up('quiz-view').pembahasan;
