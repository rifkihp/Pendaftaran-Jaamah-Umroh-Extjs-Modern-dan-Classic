...
Ext.define('Admin.view.tryout.TryOutView',{
    extend: 'Ext.Panel',
    xtype: 'tryout-view',
    ...
    items: [{
        ...
        }, 
        {
            ...
            items: [{
                xtype: 'dataview',
                itemId: 'lembartryoutsoal',
                flex: 1,
                selectable: false,
                itemCls: 'lembar-tryout-soal-item',
            ...
            {
                xtype: 'dataview',
                itemId: 'lembartryoutjawab',
                
                itemCls: 'lembar-tryout-jawab-item',
                itemTpl: new Ext.XTemplate(
