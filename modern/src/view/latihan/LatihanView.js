...
Ext.define('Admin.view.latihan.LatihanView',{
    extend: 'Ext.Panel',
    xtype: 'latihan-view',
    ...
    items: [{
        ...
        }, 
        {
            ...
            items: [{
                xtype: 'dataview',
                itemId: 'lembarlatihansoal',
                flex: 1,
                selectable: false,
                itemCls: 'lembar-latihan-soal-item',
            ...
            {
                xtype: 'dataview',
                itemId: 'lembarlatihanjawab',
                
                itemCls: 'lembar-latihan-jawab-item',
                itemTpl: new Ext.XTemplate(
